...
const Footer = () => {
  return (
    <footer className="text-white w-full mt-0">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {/* Blog */}
                <a href="https://coastalsevenconsulting.medium.com/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-300 group border border-white/30 flex-shrink-0">
                  <svg className="w-4 h-4 text-white group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">

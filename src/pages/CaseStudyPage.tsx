...
const CaseStudyPage: React.FC = () => {
  ...
  const handleReadMore = (caseStudyId: number) => {
    navigate(`/resources/case-study/${caseStudyId}`);
  };
        ...
        <div className="container mx-auto px-6 lg:px-8 mb-12">
          <div className="text-center">
            <h1 className="text-4xl font-bold">
              ...
              <span className="text-coastal-teal">Case Studies</span>
            </h1>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            {Array.from({ length: 2 }, (_, index) => (
              <div key={index} className="bg-white/20 backdrop-blur-xl rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-white/30">
                {/* Case Study Content */}
                <div className="p-6">
                  <h3 className="text-lg font-bold text-gray-800 mb-3 leading-tight">
                    How AI-Powered Analytics Transformed Retail Data into Customer Engagement and Operational Efficiency
                  </h3>
                  
                  {/* Separator Line */}
                  <div className="w-full h-0.5 bg-coastal-teal mb-4"></div>
                  
                  <p className="text-gray-700 text-sm leading-relaxed mb-5">
                    In today's competitive retail landscape, customer experience and operational agility are key drivers of growth. A mid-sized retail company with over 150 stores across three regions faced growing challenges in understanding customer behavior, predicting demand, and managing inventory. Traditional analytics tools provided fragmented insights, leaving leadership teams to rely on guesswork rather than data-driven strategies.
                  </p>
                  
                  <button 
                    onClick={() => handleReadMore(index + 1)}
                    className="bg-gradient-to-r from-[#063342] to-[#16BAAD] text-white py-2.5 px-5 rounded-lg font-medium hover:from-[#052a35] hover:to-[#14a89c] transition-all duration-300 transform hover:scale-105 shadow-sm hover:shadow-md text-sm"
                  >
                    Read Case Study
                  </button>
                </div>
